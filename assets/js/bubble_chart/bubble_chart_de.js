...
function bubbleChartDE() {
  ...
  var yearCenters = {
    ...
    22: { x:  4.1 * width / 5, y: height / 2},

    23: { x: width /2.4, y: height / 2 },
    10: { x: 2 * width / 3, y: height / 2 },
    1: { x: width, y: height },
...
function displayDE(){
  ...
  var myBubbleChart = bubbleChartDE();
  
  d3.csv('data/bubble_chart_data/de_cat_data.csv', function(error, data) {
    if (error) {
      console.log(error);
    }
