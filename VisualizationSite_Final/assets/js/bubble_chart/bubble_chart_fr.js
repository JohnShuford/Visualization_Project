...
function bubbleChartFR() {
  ...
  var yearCenters = {
    ...
    25: { x: width / 3.3, y: height / 2 },
    22: { x:  4.2 * width / 5, y: height / 2},
...
function displayFR() {
  ...
  var myBubbleChart = bubbleChartFR();
  
  d3.csv('data/bubble_chart_data/fr_cat_data.csv', function(error, data) {
    if (error) {
      console.log(error);
    }
